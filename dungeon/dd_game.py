"""Dungeon Game
Explore a dungeon to find a hidden door and escape. But watch out 
for the grue is hiding somewhere inside.
...
def build_cells(width, height):
  """Create and return a width * height grid of two-tuples
...
def get_locations(cells):
  """Randomly pick random locations for the monster, the door and player
